...
.PHONY: help init check-app test-backend-e2e refresh export-board deploy-board deploy-app deploy-all
...
help:
	...
	@echo "make refresh       In-season sync + publish for both leagues (ARGS=\"--sunday\", \"--week-roll\", \"--dry-run\")"
